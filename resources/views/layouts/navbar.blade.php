        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    @if (
                        (auth()->user()->hasRole('Laboratory Team') || auth()->user()->hasRole('Leader')) &&
                            auth()->user()->lecturer->photo)
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    @if (auth()->user()->hasRole('Laboratory Team') || auth()->user()->hasRole('Leader'))
                        <a href="{{ route('dosen.profil.index', auth()->user()->id) }}" class="dropdown-item">Profil</a>
                    @endif
