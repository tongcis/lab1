<div class="modal modal-blur fade" id="modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('dosen.store') }}" id="main-form" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <span class="text-danger error_text nis_error"></span>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control text-center" name="position" id="position">
                            ...
                            <option value="2">Tim Laboratorium</option>

                        </select>
                        <span class="text-danger error_text position_error"></span>
                    </div>
                    <div class="mb-3">
