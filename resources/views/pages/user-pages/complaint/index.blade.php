@extends('layouts.user.main', ['title' => 'Pengaduan'])
@section('content')
    ...
    @includeIf('pages.user-pages.complaint.modal')
    @includeIf('pages.user-pages.complaint.modal-detail')
@endsection
@push('js')
    <script>
        $(document).ready(function() {
            ...
            $('#room_id').change(function() {
                ...
                var url = "{{ route('pengaduan-user.getInventory') }}";
                $.ajax({
                    url: url,
                    type: 'GET',
                    data: {
