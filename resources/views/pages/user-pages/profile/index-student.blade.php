@extends('layouts.user.main', ['title' => 'Profil'])
@section('content')
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body d-flex justify-content-center">
                                    @if ($user->hasRole('Student') && $user->student->photo)
                                        <img class="img-fluid" height="500"
                                            src="{{ asset('storage/' . $user->student->photo) }}" alt="">
                                    @else
                                ...
                                <div class="card-body">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td>Program Studi</td>
                                            <td> : </td>
                                            <td>{{ $user->student->studyProgram->name }}</td>
                                        </tr>
                                    </table>
    ...
    @includeIf('pages.user-pages.profile.modal-student')
    @includeIf('pages.user-pages.profile.modal-change-password')
@endsection
@push('js')
    <script>
        $.ajaxSetup({
        ...
        $('body').on('click', '#edit', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#study_program_id').val(response.student.study_program_id);
                }
            });
        });
